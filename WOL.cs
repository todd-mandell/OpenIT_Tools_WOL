         ...
         public static class WakeOnLan
         {
             ...
             public static void Main(string[] args)
             {
                  ...
                  try
                 {
                     ...
                     string localBroadcast = args.ElementAt(1);
                  ...
                  {
                      Console.WriteLine("enter args for mac,lan-bcast (mac separated by : or - and dotted quad for IP) adds in that order separated by a schpace character...");
                      Console.ReadLine();
                  }
              }
          }
